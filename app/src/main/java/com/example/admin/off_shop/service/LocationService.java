package com.example.admin.off_shop.service;
...
import com.example.admin.off_shop.storage.AppPreferences;
import com.example.admin.off_shop.storage.IPreferenceConstants;
...
public class LocationService extends Service implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener, ILocationConstants, IPreferenceConstants {
    ...
    private void updateUI() {
        ...
        if (null != mCurrentLocation) {
            ...
            sendLocationBroadcast(sbLocationData.toString(), mCurrentLocation.getLatitude(), mCurrentLocation.getLongitude());
        } else {
     ...
     */
    private void sendLocationBroadcast(String sbLocationData, Double Lat, Double Log) {

        Intent locationIntent = new Intent();
        locationIntent.setAction(LOACTION_ACTION);
        locationIntent.putExtra(LOCATION_MESSAGE, sbLocationData);
        locationIntent.putExtra("lat", Lat);
        locationIntent.putExtra("log", Log);
